...
// Keeps Recharts out of the initial payload for this route.
const TrendLineChart = dynamic(
  () => import('@/components/features/charts/TrendLineChart'),
  { ssr: false, loading: () => <div className="shimmer h-[200px] rounded-lg" /> }
);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        <Card padding="md">
          ...
          {trendLoading ? (
            ...
            <TrendLineChart data={trendChartData} color={trendColor} />
          ) : (
